...
async def _handle_deactivate_request(message):
 ...
 title=" Pedido de Desativacao Recebido",
 color=0x000000,
 timestamp=datetime.now(timezone.utc),
 )
...
def _build_help_embed(guild, p, category: str) -> discord.Embed:
 ...
 " Moderação · Blacklist · Anti-Ban\n"
 " VIP · Tickets · Boas-vindas\n"
 " Sorteio · Instagram · Emojis\n"
 " Cargos · Permissões · Configuração\n"
 " CL · Utilitários"
 ), inline=False)
 return e
 ...
 e.add_field(name="ℹ Como funciona", value=(
 ...
 e.add_field(name=" Anti-Ban Individual", value=(
 ...
 e.add_field(name=" Configuração VIP", value=(
 ...
 e.add_field(name=" Cargos Especiais", value=(
 ...
 e.add_field(name="ℹ Prioridade", value=(
 ...
 e.add_field(name=" Configurar CL (Admin)", value=(
...
class EnviarMsgView(discord.ui.View):
 ...
 @discord.ui.button(label=" Adicionar Banner", style=discord.ButtonStyle.secondary, row=0)
 ...
 @discord.ui.button(label=" Adicionar Logo", style=discord.ButtonStyle.secondary, row=0)
...
class InstagramView(discord.ui.View):
 ...
 @discord.ui.button(label=" Curtir", style=discord.ButtonStyle.danger, custom_id="ig_like")
 async def curtir(self, interaction: discord.Interaction, button: discord.ui.Button):
 await interaction.response.send_message(
 f" **{interaction.user.display_name}** curtiu esta foto!", ephemeral=False)
